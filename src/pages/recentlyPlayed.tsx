...
const PlayedPlaylists: React.FC = () => {
...
<div className="w-full h-full grid grid-cols-4 grid-rows-2 pr-[20px] pl-[20px] gap-3 ">
  ...
  {playlists.map((playlist) => (
      <div className="bg-[#333333] w-[250px] h-[60px] rounded-[7px]   items-center justify-center cursor-pointer ">
...
export default PlayedPlaylists;
